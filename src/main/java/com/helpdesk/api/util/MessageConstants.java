...
public class MessageConstants {
    ...
    public static final String USUARIO_NAO_ENCONTRADO_C0M_ID = "Usuario not found with id ";
    ...
    public static final String OCORREU_UM_ERRO_AO_OBTER_O_CHAMADO_C0M_ID = "AN error occurred when obtaining the call com ID";
